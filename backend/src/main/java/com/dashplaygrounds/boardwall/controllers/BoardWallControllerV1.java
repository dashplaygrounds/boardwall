...
public class BoardWallControllerV1 {
    ...
    @GetMapping("/{id}")
    public BoardWall getBoardWallById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public BoardWall updateBoardWall(@PathVariable Long id, @RequestBody BoardWall updatedBoardWall) {
    ...
    // Delete a boardwall
    @DeleteMapping("/{id}")
    public void deleteBoardWall(@PathVariable Long id) {
